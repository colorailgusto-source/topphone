...
class ProfileScreen extends StatelessWidget {
  ...
  Future<void> _openMaps() async {
    final uri = Uri.parse(
        'https://maps.google.com/?q=Via+Nazionale+68+Torre+del+Greco+NA');
    await launchUrl(uri, mode: LaunchMode.externalApplication);
  }

  Future<void> _callPhone() async {
    final uri =
        Uri.parse('tel:0${AppConfig.shopPhoneInternational.substring(2)}');
    await launchUrl(uri, mode: LaunchMode.externalApplication);
  }
            ...
            child: Column(children: [
              ...
              _section('Il Mio Account', [
                ...
                _tile(
                    ...
                    'Cashback & Premi',
                    'Accumula punti e ottieni sconti',
                    Colors.amber,
                    () => context.push('/cashback')),
              ]),
              const SizedBox(height: 16),
              _section('Informazioni', [
                _tile(Icons.help_outline_rounded, 'FAQ', 'Domande frequenti',
                    Colors.indigo, () => context.push('/faq')),
                _divider(),
                _tile(
                    Icons.gavel_rounded,
                    'Note Legali',
              ...
              _section('Supporto & Contatti', [
                ...
                _divider(),
                _tileAction(Icons.phone_rounded, 'Chiama il Negozio',
                    '081 341 7717', Colors.blue,
                    onTap: _callPhone),
                _divider(),
                _tileAction(
                    Icons.location_on_rounded,
              ...
              const Text('Top Phone Torre',
                  style: TextStyle(
                      ...
                      fontFamily: 'Poppins')),
              const Text(
                  '${AppConfig.shopStreet} • ${AppConfig.shopCity} • ${AppConfig.shopPhone}',
                  style: TextStyle(
                      color: AppTheme.grey,
                      fontSize: 11,
                      fontFamily: 'Poppins')),
                ...
                child: Container(
                  ...
                  child: FutureBuilder<PackageInfo>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return Text('TopPhone Torre v$versione',
                          style: const TextStyle(
                              fontSize: 11,
                              color: AppTheme.grey,
                              fontFamily: 'Poppins'));
  ...
  Widget _tile(IconData icon, String label, String subtitle, Color color,
      VoidCallback onTap) {
    return ListTile(
      ...
      subtitle: Text(subtitle,
          style: const TextStyle(
              fontSize: 11, color: AppTheme.grey, fontFamily: 'Poppins')),
      trailing: const Icon(Icons.chevron_right, color: AppTheme.grey, size: 18),
      onTap: onTap,
    );
  }

  Widget _tileAction(IconData icon, String label, String subtitle, Color color,
