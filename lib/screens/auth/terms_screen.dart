    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          _section('1. Informazioni Generali', 'Top Phone Torre è un negozio di telefonia e accessori con sede in ' + AppConfig.shopAddress + '. Questi termini e condizioni regolano l\'utilizzo dell\'app e l\'acquisto di prodotti tramite la stessa.'),
          ...
          _section('5. Ritiro in Negozio', 'È possibile ritirare il prodotto direttamente presso il nostro negozio in ' + AppConfig.shopStreet + ', ' + AppConfig.shopCity + '. Riceverai una notifica quando il prodotto è pronto per il ritiro.'),
