...
class _AdminCategoriesScreenState extends State<AdminCategoriesScreen> {
  ...
  void _showForm({Map<String, dynamic>? cat}) {
    ...
    final ordine =
        TextEditingController(text: cat?['ordine']?.toString() ?? '0');
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setS) => Padding(
          ...
          child: SingleChildScrollView(
            ...
            Text(cat == null ? 'Nuova Categoria' : 'Modifica Categoria',
            ...
            GestureDetector(
              onTap: () async {
                ...
                if (picked != null) {
                  setS(() => selectedLogo = File(picked.path));
                }
              },
              child: Container(
                width: 80,
                ...
                child: selectedLogo != null
                    ...
                    : logoUrl.text.isNotEmpty
                        ? ClipRRect(
                            borderRadius: BorderRadius.circular(20),
                            child: Image.network(logoUrl.text,
                                fit: BoxFit.cover,
            ...
            const Text('Tocca per aggiungere logo',
                style: TextStyle(
                    color: AppTheme.grey, fontSize: 11, fontFamily: 'Poppins')),
            const SizedBox(height: 16),

            TextField(
                controller: nome,
                decoration:
                    const InputDecoration(labelText: 'Nome marca/categoria *')),
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    ...
                    if (selectedLogo != null) {
                      finalUrl = await _uploadLogo(selectedLogo!) ?? finalUrl;
                    }
                    final data = {
                      'nome': nome.text.trim(),
