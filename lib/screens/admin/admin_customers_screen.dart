...
class _AdminCustomersScreenState extends State<AdminCustomersScreen> {
  ...
  Future<void> _load() async {
    ...
    setState(() { _customers = List<Map<String, dynamic>>.from(data); _loading = false; });
  }
              ...
              itemBuilder: (c, i) {
                ...
                return Card(
                  child: ListTile(
                    ...
                    title: Row(children: [
                      Expanded(child: Text('$nome $cognome', style: const TextStyle(fontWeight: FontWeight.bold))),
                      Container(
                        ...
                        child: Text(
                          ...
                          style: TextStyle(fontSize: 11, color: isAdmin ? Colors.orange : Colors.green, fontWeight: FontWeight.bold),
                        ),
                      ),
                    ]),
                      ...
                      onPressed: () async {
                        ...
                        final confirm = await showDialog<bool>(
                          ...
                          builder: (ctx) => AlertDialog(
                            ...
                            content: Text(isAdmin ? 'Vuoi rimuovere i permessi admin a $nome?' : 'Vuoi rendere admin $nome?'),
                            actions: [
