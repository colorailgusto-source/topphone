...
class _AdminAppConfigScreenState extends State<AdminAppConfigScreen> {
  ...
  Future<void> _load() async {
    final data =
        await _client.from('app_config').select().eq('id', 'config').single();
    setState(() {
      ...
      _messaggioManutenzione.text = data['messaggio_manutenzione'] ??
  ...
  Future<void> _resetDati() async {
    ...
    final confirm1 = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        title: const Row(children: [
          ...
          SizedBox(width: 8),
          Text('Reset Dati Test')
        ]),
        content: const Text(
            'Questa operazione cancellera TUTTI gli ordini, resi, analytics e resettera le statistiche. Sei sicuro?'),
        actions: [
          TextButton(
    ...
    final confirm2 = await showDialog<bool>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
            'ULTIMA CONFERMA: tutti i dati verranno eliminati definitivamente. Continuare?'),
        actions: [
          TextButton(
              onPressed: () => Navigator.pop(ctx, false),
              child: const Text('Annulla')),
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content: Text('OK Reset completato!'),
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
            content: Text('OK Configurazione salvata!'),
            backgroundColor: Colors.green));
      }
    } catch (e) {
      if (mounted) {
                            ...
                            child: Column(
                                ...
                                children: [
                                  ...
                                  Row(children: [
                                    Expanded(
                                        child: TextField(
                                            controller: _versioneAttuale,
                                            decoration: const InputDecoration(
                                                labelText: 'Versione Attuale',
                                                hintText: '1.0.0',
                                                prefixIcon:
                                    ...
                                    Expanded(
                                        child: TextField(
                                            controller: _versioneMinima,
                                            decoration: const InputDecoration(
                                                labelText: 'Versione Minima',
                                                hintText: '1.0.0',
                                                prefixIcon: Icon(
                                  ...
                                  Container(
                                    ...
                                    child: const Row(children: [
                                      ...
                                      Expanded(
                                          child: Text(
                                              'Se la versione minima e maggiore di quella installata, gli utenti saranno forzati ad aggiornare.',
                                              style: TextStyle(
                                                  fontSize: 12,
                                                  color: Colors.orange))),
                                    ]),
                                  ...
                                  const SizedBox(height: 12),
                                  TextField(
                                      controller: _urlAggiornamento,
                                      decoration: const InputDecoration(
                                          labelText: 'URL Aggiornamento',
                                          prefixIcon: Icon(Icons.link))),
                                  const SizedBox(height: 8),
                                  TextField(
                                      controller: _messaggioAggiornamento,
                                      maxLines: 2,
                                      decoration: const InputDecoration(
                                          labelText: 'Messaggio Aggiornamento',
                    ...
                    Card(
                        child: Padding(
                            ...
                            child: Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  const Text('MODALITA MANUTENZIONE',
                                      style: TextStyle(
                                          color: AppTheme.grey,
                                          fontSize: 12,
                                          fontWeight: FontWeight.bold,
                                  ...
                                  const SizedBox(height: 12),
                                  SwitchListTile(
                                    title: const Text('Attiva Manutenzione',
                                        style: TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontFamily: 'Poppins')),
                                    subtitle: Text(
                                        _manutenzione
                                            ? 'ATTENZIONE: App bloccata per tutti tranne admin'
                                            : 'App funzionante normalmente',
                                        style: TextStyle(
                                            color: _manutenzione
                                                ? Colors.red
                                                : Colors.green,
                                                  ...
                                                  title: const Text(
                                                      ...
                                                      style: TextStyle(
                                                          fontWeight:
                                                              FontWeight.bold)),
                                                  content: const Text(
                                                      'Gli utenti non potranno accedere all\'app. Solo gli admin potranno entrare.'),
                                                  actions: [
                                                    TextButton(
                                                        onPressed: () =>
                                                            Navigator.pop(
                                  ...
                                  const SizedBox(height: 12),
                                  SwitchListTile(
                                    title: const Text('Ritiro in Negozio',
                                        style: TextStyle(
                                            fontWeight: FontWeight.w600)),
                                    subtitle: Text(
                                        _ritiroAttivo
                                            ? 'OK Ritiro disponibile'
                                            : 'NO Ritiro non disponibile',
                                        style: TextStyle(
                                            color: _ritiroAttivo
                                                ? Colors.green
                                                : Colors.red,
                                    ...
                                    onChanged: (v) =>
                                        setState(() => _ritiroAttivo = v),
                                  ),
                                  const SizedBox(height: 8),
                                  SwitchListTile(
                                    title: const Text('Spedizione a Domicilio',
                                        style: TextStyle(
                                            fontWeight: FontWeight.w600)),
                                    subtitle: Text(
                                        _spedizioneAttiva
                                            ? 'OK Spedizione disponibile'
                                            : 'NO Spedizione non disponibile',
                                        style: TextStyle(
                                    ...
                                    activeTrackColor: Colors.green,
                                    onChanged: (v) =>
                                        setState(() => _spedizioneAttiva = v),
                                  ),
                                  const SizedBox(height: 8),
                                  SwitchListTile(
                                    title: const Text(
                                        'Pagamento Klarna (a rate)',
                                        style: TextStyle(
                                            fontWeight: FontWeight.w600)),
                                    subtitle: Text(
                                        _klarnaAttivo
                                            ? 'OK Klarna disponibile'
                                            : 'NO Klarna non disponibile',
                                        style: TextStyle(
                                            color: _klarnaAttivo
                                                ? Colors.green
                                                : Colors.red,
                                    ...
                                    onChanged: (v) =>
                                        setState(() => _klarnaAttivo = v),
                                  ),
                                  const SizedBox(height: 8),
                                  TextField(
                                      controller: _klarnaMarkup,
                                      keyboardType: TextInputType.number,
                                      decoration: const InputDecoration(
                                          labelText: 'Maggiorazione Klarna (%)',
                                          prefixIcon: Icon(Icons.percent),
                                          hintText: '6')),
                                  const SizedBox(height: 12),
                                  SwitchListTile(
                                    title: const Text(
                                        'Pagamento ScalaPay (a rate)',
                                        style: TextStyle(
                                            fontWeight: FontWeight.w600)),
                                    subtitle: Text(
                                        _scalapayAttivo
                                            ? 'OK ScalaPay disponibile'
                                            : 'NO ScalaPay non disponibile',
                                        style: TextStyle(
                                            color: _scalapayAttivo
                                                ? Colors.green
                                                : Colors.red,
                                            fontSize: 12)),
                                    ...
                                    onChanged: (v) =>
                                        setState(() => _scalapayAttivo = v),
                                  ),
                                  const SizedBox(height: 8),
                                  TextField(
                                      controller: _scalapayMarkup,
                                      keyboardType: TextInputType.number,
                                      decoration: const InputDecoration(
                                          labelText:
                                              'Maggiorazione ScalaPay (%)',
                                          prefixIcon: Icon(Icons.percent),
                                          hintText: '6')),
                                  const SizedBox(height: 12),
                                  TextField(
                                      controller: _costoSpedizione,
                                      keyboardType: TextInputType.number,
                                      decoration: const InputDecoration(
                                          labelText:
                                              'Costo Spedizione (\u20AC)',
                                  ...
                                  const SizedBox(height: 12),
                                  TextField(
                                      controller: _messaggioManutenzione,
                                      maxLines: 3,
                                      decoration: const InputDecoration(
                                          labelText: 'Messaggio Manutenzione',
                    ...
                    SizedBox(
                        ...
                        child: OutlinedButton.icon(
                          ...
                          icon: const Icon(Icons.delete_forever,
                              color: Colors.red),
                          label: const Text('Reset Dati Test',
                              style:
