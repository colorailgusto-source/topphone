...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _load() async {
    try {
      ...
      final banners = await _client
          .from('banner')
          .select()
          .eq('attivo', true)
          .order('ordine');
      final categorie = await _client
          .from('categorie')
          .select()
          .eq('attiva', true)
          .order('ordine');
                ...
                child: Row(children: [
                  ...
                  const Expanded(
                      child: Column(
                          ...
                          children: [
                        Text('Top Phone Torre',
                            style: TextStyle(
                                fontWeight: FontWeight.w700,
                                fontSize: 16,
                                color: Colors.white,
                                fontFamily: 'Poppins')),
                        Text(AppConfig.shopStreet,
                            style: TextStyle(
                                fontSize: 10,
              ...
              child: Column(
                  ...
                  children: [
                          ...
                          children: [
                            ...
                            Row(children: [
                              GestureDetector(
                                onTap: () => launchUrl(
                                    Uri.parse(
                                        'https://www.facebook.com/topphonetorre/?locale=it_IT'),
                              ...
                              GestureDetector(
                                onTap: () => launchUrl(
                                    Uri.parse(
                                        'https://www.instagram.com/topphonetorre/'),
                                    mode: LaunchMode.externalApplication),
                                child: Container(
                                  padding: const EdgeInsets.all(6),
                                  decoration: BoxDecoration(
                          ...
                          itemBuilder: (c, i) {
                            ...
                            return Padding(
                              ...
                              child: Container(
                                ...
                                child: GestureDetector(
                                  onTap: () => bannerLink != null &&
                                          bannerLink.isNotEmpty
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (c, i) {
                            ...
                            return GestureDetector(
                              onTap: () =>
                                  context.push('/catalog', extra: cat['nome']),
                              child: Container(
                    ...
                    if (_loading) ...[
                      ...
                      SizedBox(
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (c, i) => const SizedBox(
                                  width: 180, child: ProductCardShimmer()))),
                      ...
                      _sectionHeader(
                          'Ultimi Arrivi 🆕', () => context.push('/catalog')),
                      SizedBox(
                        height: 320,
                        child: ListView.builder(
                          scrollDirection: Axis.horizontal,
                          padding: const EdgeInsets.symmetric(horizontal: 16),
                          itemCount:
                              _products.length > 6 ? 6 : _products.length,
                          itemBuilder: (c, i) => SizedBox(
                              ...
                              child: Padding(
                                  ...
                                  child: ProductCard(
                                      product: _products[i],
                                      variants:
                                          _variantsMap[_products[i].id]))),
                        ),
                      ),
                      _sectionHeader(
                          'Più Venduti 🔥', () => context.push('/catalog')),
                      SizedBox(
                        height: 320,
                        child: ListView.builder(
                          scrollDirection: Axis.horizontal,
                          ...
                          itemBuilder: (c, i) {
                            final sorted = List.of(_products)
                              ..sort((a, b) =>
                                  (b.vendite ?? 0).compareTo(a.vendite ?? 0));
                            final badge = i == 0 ? '⭐ #1' : '🔥 TOP';
                            final badgeColor =
                                i == 0 ? const Color(0xFFFF6B00) : Colors.red;
                            return SizedBox(
                                width: 195,
                                child: Padding(
                                    padding: const EdgeInsets.only(right: 12),
                                    child: ProductCard(
                                        ...
                                        variants: _variantsMap[sorted[i].id])));
                          },
                        ),
                      ),
                      Padding(
