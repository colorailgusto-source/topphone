...
class AppTheme {
  ...
  static ThemeData get lightTheme => ThemeData(
    ...
    inputDecorationTheme: InputDecorationTheme(
      ...
      enabledBorder: OutlineInputBorder(borderRadius: BorderRadius.circular(14), borderSide: BorderSide(color: grey.withValues(alpha: 0.2))),
      labelStyle: const TextStyle(fontFamily: 'Poppins', color: AppTheme.textMedium),
      hintStyle: TextStyle(fontFamily: 'Poppins', color: grey.withValues(alpha: 0.7)),
